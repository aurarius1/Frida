...
public class C0509d {
    ...
    public C0509d(char c, float[] fArr) {
        this.f2547a = c;
        this.f2548b = fArr;
    }

    public C0509d(C0509d c0509d) {
        this.f2547a = c0509d.f2547a;
        float[] fArr = c0509d.f2548b;
        this.f2548b = AbstractC0022t.m3479o(fArr, 0, fArr.length);
    }

    /* renamed from: a */
    public static void m2383a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d24 < 0.0d) {
            ...
            m2383a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
            return;
        }
    ...
    /* renamed from: b */
    public static void m2382b(C0509d[] c0509dArr, Path path) {
        int i;
        int i2;
        float[] fArr;
        char c;
        ...
        float f18;
        float f19;
        C0509d[] c0509dArr2 = c0509dArr;
        float[] fArr2 = new float[6];
        char c2 = 'm';
        char c3 = 0;
        char c4 = 'm';
        int i4 = 0;
        while (i4 < c0509dArr2.length) {
            char c5 = c0509dArr2[i4].f2547a;
            float[] fArr3 = c0509dArr2[i4].f2548b;
            float f20 = fArr2[c3];
            float f21 = fArr2[1];
            float f22 = fArr2[2];
            float f23 = fArr2[3];
                ...
                if (c5 != 'A') {
                    if (c5 != 'C') {
                        if (c5 == 'H') {
                            ...
                            c = c5;
                            i3 = i4;
                            m2383a(path, f46, f45, fArr3[i42] + f46, fArr3[i43] + f45, fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                            f28 = f46 + fArr[i42];
                            f29 = f45 + fArr[i43];
                        }
                        i5 = i2 + i;
                    ...
                    int i48 = i2 + 5;
                    int i49 = i2 + 6;
                    m2383a(path, f28, f29, fArr[i48], fArr[i49], fArr[i2 + 0], fArr[i2 + 1], fArr[i2 + 2], fArr[i2 + 3] != 0.0f, fArr[i2 + 4] != 0.0f);
                    f28 = fArr[i48];
                    f29 = fArr[i49];
                }
                f23 = f29;
            ...
            fArr2[5] = f27;
            i4 = i50 + 1;
            c4 = c0509dArr[i50].f2547a;
            c2 = 'm';
            c3 = 0;
            c0509dArr2 = c0509dArr;
        }
    }
}